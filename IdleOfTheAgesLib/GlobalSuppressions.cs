...
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Is a generic base class for use.", Scope = "type", Target = "~T:IdleOfTheAgesLib.UI.Elements.ElementManager`1")]
