...
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Is a generic base class that is meant to be inherited from.", Scope = "type", Target = "~T:IdleOfTheAgesLib.UI.Elements.Element`2")]
