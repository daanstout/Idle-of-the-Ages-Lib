...
/// <item>Services with a <see cref="ServiceAttribute{TInterface}"/> are registered with the <see cref="IServiceRegistry"/>.</item>
/// <item><see cref="RegisterPublicServices(IServiceRegistry)"/> is called, allowing for public services to be registered manually.</item>
/// <item><see cref="RegisterServices(IServiceRegistry)"/> is called, allowing for private services to be registered manually.</item>
...
public interface IMod {
    ...
    /// </summary>
    /// <param name="serviceLibrary">The service library for this mod.</param>
    void LoadData(IServiceLibrary serviceLibrary);
}
